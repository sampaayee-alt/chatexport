...
export class Backend implements backendInterface {
    ...
    async fetchChatPage(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchChatPage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getChat(arg0: string): Promise<Chat> {
        if (this.processError) {
            try {
    ...
    async saveChat(arg0: ChatId, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveChat(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
